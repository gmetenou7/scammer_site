...
<head>
	...
	<title>Shares &#8211; TraderPro </title>
<meta name='robots' content='noindex, nofollow' />
<link rel="alternate" hreflang="en" href="{{ route('shares') }}" />
...
<link rel="canonical" href="{{ route('shares') }}" />
...
<!-- TradingView Widget END -->		</div>
            ...
            <div class="restly-section-title">
				...
				<div class="elementor-widget-container">
					<div class="elementor-text-editor elementor-clearfix">At TraderPro you will find stocks of both popular and newly created companies. Choose which ones to invest in and collect the best investment portfolio!</div>
				</div>
				</div>
						</div>
			</div>
			...
			<div class="elementor-column-wrap  elementor-element-populated">
                ...
                <div class="tran-04 restly-service-box-three-inner  serveice3-left">
                    ...
                    <div class="service-three-dec tran-04">
                        <p>Partner with TraderPro and get cash bonuses for new clients you refer</p>
                    </div>
                </div>
            </div>
                    </div>
			...
			<div class="elementor-column-wrap  elementor-element-populated">
                ...
                <div class="restly-service-normal service-normal-hover">
                    ...
                    <div class="service-dec tran-04">
                        <p>All TraderPro traders are encouraged to trade the world&#039;s most popular indices with high liquidity</p>
                    </div>
                    <div class="service-nbtn">
                ...
                <div class="restly-service-hover service-normal-hover tran-04">
                    ...
                    <div class="service-dec tran-04">
                        <p>All TraderPro traders are encouraged to trade the world&#039;s most popular indices with high liquidity
</p>
                    </div>
                    <div class="service-hbtn">
            ...
            <div class="restly-section-title">
				...
				<div class="elementor-widget-container">
					<div class="elementor-text-editor elementor-clearfix">To start trading with TraderPro, you only need to take five minutes to register, and then fund your trading account and select assets with great growth potential. Join now and start making money on trading exchanges!</div>
				</div>
				</div>
