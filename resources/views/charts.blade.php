...
<head>
	...
	<title>Chart &#8211; TraderPro </title>
<meta name='robots' content='noindex, nofollow' />
<link rel="alternate" hreflang="en" href="{{ route('charts') }}" />
...
<link rel="canonical" href="{{ route('charts') }}" />
...
<div class="restly-template-home">
			...
			<a href="https://importcapital.cc{{ route('register') }}" class="elementor-button-link elementor-button elementor-size-lg elementor-animation-hang" role="button">
